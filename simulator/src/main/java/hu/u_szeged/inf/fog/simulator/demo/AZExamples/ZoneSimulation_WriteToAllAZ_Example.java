...
public class ZoneSimulation_WriteToAllAZ_Example {
    ...
    public static void main(String[] args) throws Exception {
        ...
        region.handleWriteRequest(writeRequest, file, userLongitude, userLongitude);

        // Read Request: Retrieve data from a specific AZ based on selection logic
